...
export function UsersIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <path
        d="M15.5 4.3c1.5.4 2.5 1.8 2.5 3.4 0 1.6-1 3-2.5 3.4M17.5 14.3c2 .5 3.5 2.2 3.5 4.7"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
...
export function QuestionMarkIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <circle cx="12" cy="12" r="8.5" stroke="currentColor" strokeWidth="1.6" />
      <path
        d="M9.6 9.3a2.4 2.4 0 1 1 3.4 2.2c-.9.4-1.4 1-1.4 2.1"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
      <circle cx="11.7" cy="16.6" r="0.9" fill="currentColor" />
    </svg>
  );
}
