      ...
      <div className="p-6">
        ...
        <div className="mt-5 space-y-5">
          <Section title={dict.religionSection}>
            <DetailRow label={dict.madhhabLabel} value={labelOf(profile.madhhab, isMadhhab, labels.madhhab)} />
            <DetailRow
            ...
            />
            {isFemale && (
              <DetailRow label={dict.hijabLabel} value={labelOf(profile.wearsHijab, isHijabOption, labels.hijabOption)} />
            )}
          </Section>
          ...
          <Section title={dict.lifeSection}>
            ...
            />
            <DetailRow label={dict.heightLabel} value={profile.height ? `${profile.height} ${dict.heightUnit}` : null} />
