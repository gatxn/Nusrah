      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/60">
              <li><LocaleLink href="/msaada#faq" className="hover:text-white">{footer.faq}</LocaleLink></li>
              <li><LocaleLink href="/usalama" className="hover:text-white">{footer.safety}</LocaleLink></li>
              <li><LocaleLink href="/masharti-ya-matumizi" className="hover:text-white">{footer.terms}</LocaleLink></li>
