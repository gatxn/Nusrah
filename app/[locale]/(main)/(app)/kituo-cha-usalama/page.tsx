...
// Same content as the public Usalama (Safety Center) page — reuses the same
// dictionary data — but stays inside the sidebar app shell instead of
// bouncing a logged-in user out to the marketing page.
export default async function SafetyCenterAppPage() {
